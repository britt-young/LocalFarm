            ...
            <strong>
              <span style={{ fontSize: 15 }}>
                <span data-custom-class="subtitle">
                  Last updated <bdt className="question">December 01, 2024</bdt>
                </span>
              </span>
            </strong>
          </span>
              ...
              <span style={{ fontSize: 15, color: "rgb(89, 89, 89)" }}>
                <span data-custom-class="body_text">
                  ...
                  <span style={{ color: "rgb(0, 58, 250)" }}>
                    <bdt className="question">localfarm.com</bdt>
                  </span>
                  <span style={{ fontSize: 15 }}>
                    <span style={{ color: "rgb(89, 89, 89)" }}>
                      <span data-custom-class="body_text">
        ...
        <div style={{ lineHeight: "1.5" }}>
            ...
            <span style={{ fontSize: 15 }}>
              <span style={{ color: "rgb(127, 127, 127)" }}>
                <span data-custom-class="body_text">
                  ...
                  <bdt className="question">localfarm@protonmail.com</bdt>.
                </span>
              </span>
            </span>
          </div>
          ...
          <div style={{ lineHeight: "1.5" }}>
            ...
            <a
              ...
              href="https://app.termly.io/notify/c61bae9f-f285-438c-bbd7-64beb8feb026"
                                        ...
                                        >
                                          <span style={{ fontSize: 15 }}>
                                            <span data-custom-class="body_text">
                                              ...
                                              Services that may contain personal
                                              information.
                                              <bdt className="statement-end-if-in-editor" />
                                            </span>
                                          </span>

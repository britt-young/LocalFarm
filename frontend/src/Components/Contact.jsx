  ...
  return (
    <div className="mb-24">
      ...
      <div className="container mx-auto px-6 md:px-20">
        <div className="block rounded-lg bg-[hsla(0,0%,100%,0.4)] px-6 py-12 shadow-[0_2px_15px_-3px_rgba(0,0,0,0.07),0_10px_20px_-2px_rgba(0,0,0,0.04)] md:py-12 md:px-12 -mt-[100px] backdrop-blur-[30px] border border-gray-300">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:gap-20">
            {/* Location Card */}
            <div className="w-full mb-12 md:mb-0">
              <h3 className="mb-10 flex justify-center">
                Visit us!
              </h3>
              <div className="block max-w-full rounded-lg bg-white text-left text-surface shadow-secondary-1 ">
                <div className="p-6 mb-2">
                  <h5 className="mb-1 text-xl font-medium leading-tight ">
                    Local Grocery
                  </h5>
                  <h6 className="mb-0 text-base font-medium leading-tight text-surface/75 dark:text-neutral-300">
                ...
                <div className="block max-w-full rounded-lg bg-white text-left text-surface shadow-secondary-1">
                  <div className="p-6">
                    ...
                    <a
                      type="button"
                      href="events"
                      className="pointer-events-auto inline-block cursor-pointer rounded text-base font-normal leading-normal text-indigo-500 transition duration-150 ease-in-out hover:text-primary-600 focus:text-primary-600 focus:outline-none focus:ring-0 active:text-primary-700 dark:text-primary-400"
                    >
            ...
            <div className="w-full">
              <h3 className="mb-10 text-center text-gray-800">
              ...
              <form ref={form} onSubmit={sendEmail} className="space-y-4">
                ...
                <div className="flex justify-center">
                  <input
                    type="submit"
                    value="Send"
                    className="cursor-pointer inline-block rounded border-2 bg-lime-900 border-white px-6 pb-[6px] pt-2 text-xs font-normal uppercase tracking-widest leading-normal text-white transition duration-500 ease-in-out hover:border-black hover:text-black focus:border-neutral-300 focus:text-neutral-200 focus:outline-none focus:ring-0 active:border-neutral-300 active:text-neutral-200 dark:hover:bg-white dark:focus:bg-white"
                  />
                </div>
              </form>
